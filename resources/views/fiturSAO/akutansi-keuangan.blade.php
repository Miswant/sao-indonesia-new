        ...
        <div class="row g-5">
          ...
          <p><strong></strong></p>
            <h3>Akutansi dan  <em>keuangan </em></h3>
                  <p><i class="bi bi-check2"></i> Modul ini membantu dalam pelacakan transaksi keuangan, pembayaran, faktur, laporan keuangan, dan pembuatan anggaran.</p>
          ...
          <div class="col-lg-6 col-md-6 order-first order-md-last d-flex align-items-center">
            <div class="img">
              <img src="assets/img/fiturSAO/akutansi.png" alt="" class="img-fluid">
            </div>
          </div>
